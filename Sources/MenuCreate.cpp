...
/*This will load all the folders and entrys*/
	...
	/////////////////////
		...
		ADDON->Append(EntryWithHotkey(new MenuEntryExtras("Character_CHANGE", CharacterChange, "Character_CHANGE_NOTE"), { 
			HotkeyExtras(Key::R | Key::X, "Key")
		})),
	...
	////////////////////////
		...
		DEFAULTC->Append(new MenuEntry("Set Custom Sprites For Seed Items And Pro Designs", nullptr, SetCustomSpritesForProDesigns, "")),
